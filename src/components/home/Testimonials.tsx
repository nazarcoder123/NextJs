  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: `url('/images/subscribe-bg.png')` }}
      >
        <div className="container text-center">
          ...
          >
            <input
              ...
              className="px-6 py-3 rounded-l-full w-full max-w-md text-gray-800 outline-none"
            />
            <button
              type="submit"
              className="bg-black text-white px-6 py-3 rounded-r-full font-semibold hover:bg-gray-800 transition"
            >
              Subscribe
            </button>
          </motion.form>
